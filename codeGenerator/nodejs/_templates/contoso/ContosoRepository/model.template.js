...
namespace Contoso.Models
{
    ...
    public interface I${table.modelName}Repository
    {
        ...
        /// Returns all ${table.modelName}s. 
        /// </summary>
        //${table.primaryKey ? "" : "//"}${table.modelName} Get(Guid id);
