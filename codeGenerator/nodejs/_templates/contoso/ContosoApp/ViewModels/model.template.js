for (const table of tables) {
    const outFilePath = `${generatedFileConfig.outDirPath}/${table.modelName}ViewModel.cs`;
...
namespace Contoso.App.ViewModels
{
    ...
    public class ${table.modelName}ViewModel : BindableBase, IEditableObject
    {
        ...
        /// </summary>
        public ${field.destLangType} ${field.Name}
        {
        ...
        /// </summary>
        public ObservableCollection<${table.modelName}> ${table.codeName} { get; } = new ObservableCollection<${table.modelName}>();

        private bool _is${table.modelName}Loading;
        ...
        {
            // RefreshOrders();
            ${table.primaryKey ? "": "//"}Model = await App.Repository.${table.codeName}.GetAsync(Model.Id);
        }
