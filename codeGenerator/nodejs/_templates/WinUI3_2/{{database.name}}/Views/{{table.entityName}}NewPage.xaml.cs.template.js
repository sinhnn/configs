...
namespace ${context.namespace}
{
    ...
    public sealed partial class ${table.entityName}NewPage : Page
    {
        ...
        /// </summary>
        public ${table.entityName}NewPage()
        {
            InitializeComponent();
        }
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            // if (e.Parameter == null)
            // {
                ViewModel = new ${table.entityName}ViewModel (new ${table.entityName}(), App.${table.entityName.ToVariableName()}MainViewModel)
                {
                    IsNew = true
                    // , IsInEdit = true
                    // Parent = 
            ...
            //         item => item.Model.Id == (Guid)e.Parameter).First();
            // }
