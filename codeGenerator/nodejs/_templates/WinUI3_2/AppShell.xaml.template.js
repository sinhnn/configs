`
<Page
    x:Class="${context.namespace}.AppShell"
    xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
    xmlns:x="http://schemas.microsoft.com/winfx/2006/xaml"
    xmlns:d="http://schemas.microsoft.com/expression/blend/2008"
    xmlns:mc="http://schemas.openxmlformats.org/markup-compatibility/2006"
    xmlns:uc="using:${context.namespace}.UserControls"
        ...
        <muxc:NavigationView
            ...
            ${tables.map(table => `
                <muxc:NavigationViewItem
                    x:Name="${table.entityName}ListMenuItem"
                    Content="{x:Bind ${table.entityName}ListLabel}" 
                    ToolTipService.ToolTip="{x:Bind ${table.entityName}ListLabel}"
                    Icon="ContactInfo"/>
            `).join("")}
            </muxc:NavigationView.MenuItems>
